...
```bash
curl -O https://raw.githubusercontent.com/chunwaibob/reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```

国内服务器：

```bash
curl -O https://jihulab.com/chunwaibob/reinstall/-/raw/main/reinstall.sh || wget -O reinstall.sh $_
```
